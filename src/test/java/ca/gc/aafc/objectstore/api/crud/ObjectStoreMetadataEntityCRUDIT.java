...
public class ObjectStoreMetadataEntityCRUDIT extends BaseEntityCRUDIT {
  ...
  private final ObjectStoreMetadata objectStoreMetaUnderTest = ObjectStoreMetadataFactory
      ...
      .acMetadataCreator(UUIDHelper.generateUUIDv7())
      .dcCreator(UUIDHelper.generateUUIDv7())
...
//        .toOffsetDateTime());
    ...
    assertTrue(objectStoreMetaUnderTest.getAcDigitizationDate()
        .isEqual(fetchedObjectStoreMeta.getAcDigitizationDate()));
