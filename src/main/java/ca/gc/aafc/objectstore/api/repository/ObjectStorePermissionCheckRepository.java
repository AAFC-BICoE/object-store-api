...
public class ObjectStorePermissionCheckRepository extends PermissionCheckRepository {

  public ObjectStorePermissionCheckRepository(List<DinaRepositoryV2<?, ?>> dinaRepositories) {
